...
Papers will be submitted using our [CMT submission portal](https://cmt3.research.microsoft.com/CtrlGen2021/Submission/Index) and go through double-blind review. Please ensure to select the "Papers" category when submitting. Submissions should be a single .pdf file that is fully anonymized, with up to 8 pages of content (9 pages for cam-ready) and unlimited references and appendices, following the [NeurIPS style template](https://neurips.cc/Conferences/2021/PaperInformation/StyleFiles). **UPDATE**: please use this [modified style file](neurips_2021.sty) instead of the original. Supplementary material in the form of code and small data files can be submitted separately as a single .zip file. An option to upload supplementary material shows up in the author console after the paper is submitted. 
